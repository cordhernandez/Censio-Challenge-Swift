...
class GetRandomPhoto: NSObject {
    
    static var photoAPI: String?
    typealias Callback = (GetRandomPhotoModel) -> ()
    
    open static func getRandomPhoto(with query: String, callback: @escaping Callback) {
        
        photoAPI = "https://api.unsplash.com/photos/random?query=\(query)"
